...
% mem_dim_mem_size
% all1_t = csvread(strcat('../Prediction1/Test1_', noise, '_', SNR, '/NTM_mem_64.csv'));
% all2_t = csvread(strcat('../Prediction2/Test1_', noise, '_', SNR, '/NTM_mem_64.csv'));
all1_t = csvread(strcat('../Prediction1/Test1_', noise, '_', SNR, '/Recall_77.csv'));
all2_t = csvread(strcat('../Prediction2/Test1_', noise, '_', SNR, '/Recall_77.csv'));

%% Slice

audpath = strcat('../../Enhancement/Test1_', noise, '_', SNR, '/Target1/');
...
for idx=1:6
    ...
    audpath1 = strcat('../../Enhancement/Test1_', noise, '_', SNR, '/Target1/Audio/', int2str(idx), '/');
    audpath2 = strcat('../../Enhancement/Test1_', noise, '_', SNR, '/Target2/Audio/', int2str(idx), '/');
...
%%
% get mix_phase
audpath_pha = strcat('../../Enhancement/Test1_', noise, '_', SNR, '/Mix/phase/');
audpath_mag = strcat('../../Enhancement/Test1_', noise, '_', SNR, '/Mix/');
