...
all1_t = csvread(strcat('../Prediction1/Test1/Recall_', int2str(num_speaker), '.csv'));
all2_t = csvread(strcat('../Prediction2/Test1/Recall_', int2str(num_speaker), '.csv'));
...
for idx=1:6
    ...
    audpath1 = strcat('../../Enhancement/Test1/Target1/Audio/', int2str(idx), '/');
    audpath2 = strcat('../../Enhancement/Test1/Target2/Audio/', int2str(idx), '/');
...
%%
% get mix_phase
audpath_pha = strcat('../../Enhancement/Test1/Mix/phase/');
audpath_mag = strcat('../../Enhancement/Test1/Mix/');
