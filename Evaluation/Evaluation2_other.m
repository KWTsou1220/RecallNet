...
all1_t = csvread(strcat('../Prediction1/Test2/Recall_', int2str(num_speaker), '.csv'));
all2_t = csvread(strcat('../Prediction2/Test2/Recall_', int2str(num_speaker), '.csv'));

%% Slice

audpath = strcat('../../Enhancement/Test2/Target1/');
...
for idx=1:6
    ...
    audpath1 = strcat('../../Enhancement/Test2/Target1/Audio/', int2str(idx), '/');
    audpath2 = strcat('../../Enhancement/Test2/Target2/Audio/', int2str(idx), '/');
...
%%
% get mix_phase
audpath_pha = strcat('../../Enhancement/Test2/Mix/phase/');
audpath_mag = strcat('../../Enhancement/Test2/Mix/');
